...
obj_list <- list(aaUntr_1, aaUntr_2, aaUntr_3, aaUntr_4, attenuated_1, attenuated_2, attenuated_3, attenuated_4, adeno_1, adeno_2, adeno_4, mRNA_1, mRNA_2, mRNA_3)
names(obj_list) <- c("aaUntr_1", "aaUntr_2", "aaUntr_3", "aaUntr_4", "attenuated_1", "attenuated_2", "attenuated_3", "attenuated_4", "adeno_1", "adeno_2", "adeno_4", "mRNA_1", "mRNA_2", "mRNA_3") 
...
write.table(DoubSing, "./DoubSing_nasal_exp1.txt", sep="\t", quote=FALSE)
...
saveRDS(hamster_all, "./seu_nasal_exp1_combined_250.rds")
