...
obj_list <- list(aaUntr_1, aaUntr_3, aaUntr_4, att2x_2, adeno2x_2, adeno2x_3, mRNA2x_1, mRNA2x_2, mRNAatt_1, mRNAatt_2, mRNAatt_3)
names(obj_list) <- c("aaUntr_1", "aaUntr_3", "aaUntr_4", "att2x_2", "adeno2x_2", "adeno2x_3", "mRNA2x_1", "mRNA2x_2", "mRNAatt_1", "mRNAatt_2", "mRNAatt_3") 
...
write.table(DoubSing, "./DoubSing_nasal_exp2.txt", sep="\t", quote=FALSE)



hamster_all <- merge(aaUntr_1, y = c(aaUntr_3, aaUntr_4, att2x_2, adeno2x_2, adeno2x_3, mRNA2x_1, mRNA2x_2, mRNAatt_1, mRNAatt_2, mRNAatt_3), add.cell.ids = c("aaUntr_1", "aaUntr_3", "aaUntr_4", "att2x_2", "adeno2x_2", "adeno2x_3", "mRNA2x_1", "mRNA2x_2", "mRNAatt_1", "mRNAatt_2", "mRNAatt_3"), project = "impf_exp2")

saveRDS(hamster_all, "./seu_nasal_exp2_combined_250.rds")
